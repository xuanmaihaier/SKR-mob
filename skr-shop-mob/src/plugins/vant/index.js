...
import {
  ...
  Button, NavBar, Icon, Swipe, SwipeItem, Lazyload, Dialog, Tabs, Tab, Cell, Toast, CellGroup, DropdownMenu, Popup, DropdownItem, List, Collapse, CollapseItem, TreeSelect,GoodsAction, GoodsActionIcon, GoodsActionButton, ShareSheet,PullRefresh,Card,Form,Field  
} from "vant"
// use使用
Vue.use(GoodsAction);
Vue.use(NavBar);

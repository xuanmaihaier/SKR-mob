<template>
  <div class="shop-car-list">
    ...
    <van-submit-bar :price="settlement*100" button-text="提交订单" @submit="onSubmit">
      <van-checkbox v-model="checkAll" checked-color="#ee0a24" @change="oncheckAll" class="checkAll">全选</van-checkbox>
    </van-submit-bar>
  </div>
</template>
...
export default {
  ...
  created() {
    // this.Id = sessionStorage.getItem('customer_id')
    console.log(this.Id);
